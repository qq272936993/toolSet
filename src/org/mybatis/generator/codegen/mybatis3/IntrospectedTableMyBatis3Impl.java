...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
	...
	public List<GeneratedJavaFile> getGeneratedJavaFiles() {
		...
		for (AbstractJavaGenerator javaGenerator : javaModelGenerators) {
			...
			for (CompilationUnit compilationUnit : compilationUnits) {
				...
				answer.add(gjf);
				//yws update start
				javaGenerator.MODEL_NAMEPACKAGE_MAP.put(gjf.getCompilationUnit().getType().getShortName(),
						gjf.getCompilationUnit().getType());
				//yws update end
			}
		}

		//生成java Interface Mapper接口的关键方法.
	...
	public void setJavaModelGenerators(
			List<AbstractJavaGenerator> javaModelGenerators) {
		this.javaModelGenerators = javaModelGenerators;
	}
	public List<AbstractJavaGenerator> getClientGenerators() {
		return clientGenerators;
	}
	public void setClientGenerators(List<AbstractJavaGenerator> clientGenerators) {
		this.clientGenerators = clientGenerators;
	}
	public AbstractXmlGenerator getXmlMapperGenerator() {
		return xmlMapperGenerator;
	}
	public void setXmlMapperGenerator(AbstractXmlGenerator xmlMapperGenerator) {
