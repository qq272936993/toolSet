...
/**
 * <pre>
 * 文件名称: DB2PaginationPalugin.java
 ...
 * </pre>
 */
public class DB2PaginationPalugin extends PluginAdapter{
	 ...
	 @Override  
	    ...
	    public boolean sqlMapDocumentGenerated(Document document,  
	       ...
	       pageStart.addElement(new TextElement("select * from( select row_.*,row_number() over (order by "+primaryKey+" desc ) as rownum_ from (")); 
