...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		//yws mybatis writer start
		ATTR_SELECT_BY_PAGIN_ID,
		//yws mybatis writer end
	}
	...
	//yws mybatis writer start
	public void setSelectPagin(String s){
		internalAttributes.put(InternalAttribute.ATTR_SELECT_BY_PAGIN_ID, s);
	}
	//yws mybatis writer end
	...
	//yws mybatis writer start
	public String getSelectPaginId(){
		return internalAttributes.get(InternalAttribute.ATTR_SELECT_BY_PAGIN_ID);
	}
	//yws mybatis writer end
